            ...
            <form id="productForm" enctype="multipart/form-data">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="title" name="title" placeholder="e.g., Professional Headshot Session" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" placeholder="Describe what's included, duration, deliverables..." required></textarea>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="price" name="price" placeholder="e.g., 250.00" step="0.01" min="0.01" required>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="keywords" name="keywords" placeholder="e.g., portrait, headshot, professional">
